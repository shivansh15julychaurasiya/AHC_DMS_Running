...
public class AmendmentController 
{
	...
	public String searchUser(HttpServletRequest request) {
		...
		List<EfilingUser> users=amendmentService.searchUser(name);
	...
	public String getApplicationTypes(HttpServletRequest request) {
		...
		List<EfilingApplicationTypes> app = null;

		ActionResponse<EfilingApplicationTypes> response = new ActionResponse<EfilingApplicationTypes>();
		String jsonData = null;

		app = amendmentService.getApplicationTypes();
