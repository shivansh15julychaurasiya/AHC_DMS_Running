	...
	<div class="container-fluid" ng-controller="CaseFileCtrl">
		...
		<div id="mySidenav" class="sidenav" title="Notes">
			...
			<textarea rows="5" id="comment" placeholder="insert some text"
				ng-model="nt.nt_notes" ng-model-options="{debounce: 500}"
				ng-change="saveNotes(nt)"></textarea>
		...
		<div class="row">
			<div class="panel panel-inverse" style="min-height: 950px;">
				<div class="col-md-4" id="metaDataPanel">
					<div class="panel-heading" id="casePanelHeading"
						style="background-color: white; color: black; top: 50.2px; position: sticky; z-index: 1;">
						...
						<h4 class="panel-title" style="font-size: 6mm; font-weight: bold;">{{casefile.caseType.ct_label}}
							&nbsp No.&nbsp{{casefile.fd_case_no}}&nbsp of
							&nbsp{{casefile.fd_case_year}}</h4>

						<c:if test="${isImpugnedOrder==1}">
							<h4 class="panel-title">Impugned Order Details
								${casetype}/${caseno}/${caseyear}</h4>
						</c:if>
					</div>
					<div class="panel-heading"
						style="background-color: white; color: white; top: 90.2px; position: sticky; z-index: 1; padding: 8px 0px 5px 0px;">
						<div class="panel-heading-btn">
							<!--  <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" ng-click ="changeTop()" data-click="panel-expand"><i class="fa fa-expand"></i></a> -->
							<!--       <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" ng-click ="changeTop()" data-click="panel-expand"><i class="fa fa-expand"></i></a> -->
						...
						<div class="btn-group" role="group"
							style="position: sticky; top: 90.2px;">

							<%
	if (role.equals("ECOURT") || role.equals("Judge")) {
%>
							<button class="btn btn-success btn-sm" ng-click="openNav()"
								id="btn_click" style="position: sticky; top: 90.2px;">Notes</button>
...
%>
							...
							<button class="btn btn-success btn-sm" ng-click="viewAllOrders()"
								style="position: sticky; top: 90.2px;">View All Orders</button>
...
%>
							<button class="btn btn-success btn-sm" ng-click="downloadfiles()"
								style="position: sticky; top: 90.2px;">DownloadFile</button>

							<span ng-if="casefile.notificationCount">
								<button class="btn btn-success btn-sm" data-toggle="modal"
									ng-click="getNotification(casefile)" id="notification"
									data-target="#notificationview"
									style="position: sticky; top: 90.2px;">
									Objection <span class="badge"
										ng-if=casefile.notificationCount!="0">{{casefile.notificationCount}}</span>
								</button>
							</span> <span ng-if="casefile.pendingAppCount">
								<button class="btn btn-success btn-sm" data-toggle="modal"
									ng-click="getPendingApp(casefile)" id="notification"
									data-target="#pendingAppview"
									style="position: sticky; top: 90.2px;">
									Scrutiny Pending <span class="badge"
										ng-if=casefile.pendingAppCount!="0">{{casefile.pendingAppCount}}</span>
								</button>
							</span>
...
%>  --%>
					...
					<input type="hidden" id="loggedUserId" value="<%= user.getUm_id() %>">
						<input type="hidden" class="form-control" value=${doc_id
							} id="doc_id" name="doc_id"> <input type="hidden"
							class="form-control" value=${document_name } id="document_name"
							name="document_name">
    ...
    <div id="pdfBookmarks" style="margin-top:10px;">
        <h5 style="background:#f1f1f1;padding:5px;margin:0;">
            PDF Bookmarks
        </h5>
        <ul id="bookmarkList" style="list-style:none;padding-left:10px;"></ul>
    </div>
				...
				<div class="col-md-8" id="myDiv">
					<link
						href="${pageContext.request.contextPath}/assets/css/custom.css"
						rel="stylesheet" />
					<iframe height="800" width="800" ng-src="{{searchUrl}}"   id="pdfFrame"> </iframe>
				</div>
			...
			<!-- afnan create  -->
			<div class="modal fade" id="notificationview" tabindex="-1"
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<h5 class="modal-title" id="myModalLabel">
								<strong>Objection On Application </strong>
							</h5>
						</div>
			...
			<div class="modal fade" id="pendingAppview" tabindex="-1"
				role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg" style="width: 70%;">
					<div class="modal-content">
						<div class="modal-header">
			...
			<div class="modal fade" id="editsubDocument" tabindex="-1"
				role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="myModalLabel">
								<strong>Change Application Type</strong>
							</h4>
						</div>
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/scripts/controllers/CaseFileViewController.js"></script>
