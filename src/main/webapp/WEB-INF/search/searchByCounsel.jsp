		...
		<div class="row">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Search By Counsel</h4>
				</div>
				<div class="panel-body">
					<div class="table-responsive">
					<form name="searchbycounsel">
						<table class="table table-striped table-bordered nowrap table-hover">
							<thead>
								<tr>
								<td>Counsel Type</td>
								<td>Counsel Name<span class="text-danger">*</span><br/>(at least 3 characters)</td>
								<td>Case Type</td>
								<td>Case No</td>
								<td>Case Year</td>
								<td>Action</td>
								...
								<tr>
									<td>
										<select class="form-control" required ng-init="searchmodel.counselType='pr'" ng-model="searchmodel.counselType">
											<option value="p">Petitioner Counsel</option>
											<option value="r">Respondent Counsel</option>
											<option value="pr">Don't Know</option>
										</select>
									</td>
									<td>
										<input type="text" class="form-control" ng-minlength="3" required placeholder="Counsel Name" ng-model="searchmodel.counselName">
									</td>
									<td width="25%">
									...
									<td>
										<button id="search" type="submit" ng-disabled="searchbycounsel.$invalid"
											class="btn btn-primary btn-sm" ng-click="searchByCounsel(1)">Search</button>
									</td>
								</tr>
						...
						<dir-pagination-controls
							...
							boundary-links="true" 
							pagination-id="id2"
							on-page-change="searchByCounsel(newPageNumber)" >
						</dir-pagination-controls>
					</div>
