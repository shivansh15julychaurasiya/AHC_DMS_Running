		...
		<div class="row">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading">
					...
					<h4 class="panel-title">Search By Party</h4>
				</div>
				<div class="panel-body">
					...
					<form name="searchbyparty">
						<table class="table table-striped table-bordered nowrap table-hover">
							<thead>
								<tr>
								<td>Party Type<span class="text-danger">*</span></td>
								<td>Party Name<span class="text-danger">*</span><br/>(at least 3 characters)</td>
								<td>Case Type</td>
								<td>Case No</td>
								<td>Case Year</td>
								<td>Action</td>
								...
								<tr>
									<td>
										<select class="form-control" ng-init="searchmodel.partyType='pr'" required ng-model="searchmodel.partyType">
									...
									<td>
										<input type="text" class="form-control" ng-minlength="3"  required placeholder="Party Name" ng-model="searchmodel.partyName">
									</td>
									<td width="25%">
									...
									<td>
										<button id="search" type="submit" ng-disabled="searchbyparty.$invalid"
											class="btn btn-primary btn-sm" ng-click="searchByParty(1)">Search</button>
									</td>
								</tr>
						...
						<dir-pagination-controls
							...
							boundary-links="true" 
							pagination-id="id2"
							on-page-change="searchByParty(newPageNumber)" >
						</dir-pagination-controls>
					</div>
